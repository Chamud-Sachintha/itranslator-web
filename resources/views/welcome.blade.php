    ...
    <div class="container">
      <div class="row no-gutters slider-text js-fullheight align-items-center "
        ...
        <div class="col-md-6 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
          ...
          <p><a href="#" class="btn btn-primary py-3 px-4" data-toggle="modal" data-target="#modalAppointment">Request a
              Quote</a></p>
        </div>
      </div>
    </div>
      ...
      <div class="row no-gutters">
        ...
        <div class="col-md-7 col-lg-9 ftco-animate p-4 p-md-5 d-flex align-items-center">
          <div class="tab-content pl-lg-4" id="v-pills-tabContent">
            <div class="tab-pane fade show active py-0 py-lg-5" id="v-pills-1" role="tabpanel"
...
<!-- <cards Reason For Choosing Us "> -->
  ...
  <!-- <script defer=""
    ...
    data-cf-beacon="{" rayid":"8309aa6f0cef0e94","version":"2023.10.0","token":"cd0b4b3a733644fc843ef0b185f98241"}"=""
